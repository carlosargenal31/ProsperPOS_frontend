...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "category-list-simple", component: () => import('@/views/pages/inventory/category-list-simple.vue') },
      { path: "test-categories", component: () => import('@/views/pages/inventory/test-categories.vue') },
