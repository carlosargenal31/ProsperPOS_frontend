...
import SupplierModal from "@/components/modal/supplier-modal.vue";
import StoreListModal from "@/components/modal/store-list-modal.vue";
import CityModal from "@/components/modal/city-modal.vue";
import StateModal from "@/components/modal/state-modal.vue";
import CountryModal from "@/components/modal/country-modal.vue";
import BranchModal from "@/components/modal/branch-modal.vue";
import VehicleModal from "@/components/modal/vehicle-modal.vue";
...
import BeneficiaryTypeSettingsModal from "@/components/modal/beneficiary-type-settings-modal.vue";
...
app.component("country-modal", CountryModal);
app.component("branch-modal", BranchModal);
app.component("vehicle-modal", VehicleModal);
...
app.component("beneficiary-type-settings-modal", BeneficiaryTypeSettingsModal);
app.component("coupon-modal", CouponModal);
...
app.component('position-modal', PositionModal);
