      ...
      <div class="page-header">
        ...
        <div class="page-btn d-flex gap-2">
          <a
            ...
            @click="openAddModal"
          >
            <i class="ti ti-circle-plus me-1"></i>Agregar Nueva Sucursal
          </a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Guardar Reporte - Sucursales</h5>
  ...
  methods: {
    ...
    saveAsExcel() {
      ...
      try {
        ...
        const data = this.sortedBranches.map(branch => ({
          ...
          'Ciudad': branch.city_name || '-',
          'Departamento': branch.state_name || '-',
        ...
        XLSX.writeFile(wb, `sucursales_${new Date().toISOString().split('T')[0]}.xlsx`);
      } catch (error) {
    ...
    async saveAsPDF() {
      ...
      try {
        ...
        pdf.save(`sucursales_${new Date().toISOString().split('T')[0]}.pdf`);
    ...
    async saveAsImage() {
      ...
      try {
        ...
        link.download = `sucursales_${new Date().toISOString().split('T')[0]}.png`;
    ...
    async buildReportHTML() {
      ...
      const tableRows = this.sortedBranches.map(branch => `
        <tr>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.id}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.nombre}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.city_name || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.state_name || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.gerente || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${branch.telefono || '-'}</td>
        ...
        <body>
          <div class="header-section">
            ...
            <div class="report-box">
              <div class="report-title">REPORTE DE SUCURSALES</div>
