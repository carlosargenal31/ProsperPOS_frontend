                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Austa" v-model="selected" placeholder="Select" />
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Tasmania" v-model="selectedOne" placeholder="Select" />
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue-select :options="Anchorage" v-model="selectedTwo" placeholder="Select" />  
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
