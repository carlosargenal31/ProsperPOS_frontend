    ...
    <div class="content">
      <div class="table-tab">
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/supplier-report/supplier-due-report"
              >Supplier Due</router-link
            >
          </li>
        </ul>
      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="mb-3">
                        ...
                        <vue-select :options="HeadSupp" v-model="selected" placeholder="All" />
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label class="form-label">Payment Status</label>
                        <vue-select :options="PayALL" v-model="selectedOne" placeholder="All" />
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="mb-3">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2025</a></td>
                    <td>SU001</td>
                    <td>
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2042</a></td>
                    <td>SU003</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2033</a></td>
                    <td>SU004</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2011</a></td>
                    <td>SU006</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2014</a></td>
                    <td>SU007</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2056</a></td>
                    <td>SU008</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2047</a></td>
                    <td>SU009</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
                  ...
                  <tr>
                    <td><a href="#" class="text-primary">INV/PO2017</a></td>
                    <td>SU010</td>
                    <td>
                      <div class="d-flex align-items-center">
                        <a href="#" class="avatar avatar-md me-2">
  ...
  data() {
    return {
      ...
      HeadSupp: [
        ...
        {label: "Beats Headphones", value: "Beats Headphones"},
