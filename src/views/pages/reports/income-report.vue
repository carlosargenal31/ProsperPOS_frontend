                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <vue-select :options="PrimBa" v-model="selected" placeholder="All" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-3">
                      <label class="form-label">Payment Method</label>
                      <vue-select :options="Paycard" v-model="selectedOne" placeholder="All" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table datatable">
              ...
              <tbody>
                <tr>
                  <td><a href="#" class="text-orange">INV849</a></td>
                  <td>24 Dec 2024</td>
                  <td>Electro Mart</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV848</a></td>
                  <td>10 Dec 2024</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV847</a></td>
                  <td>27 Nov 2024</td>
                  <td>Prime Bazaar</td>
                  <td>Installation</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV846</a></td>
                  <td>18 Nov 2024</td>
                  <td>Gadget World</td>
                  <td>Product Sales</td>
                  <td>Services that have been verified</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV845</a></td>
                  <td>06 Nov 2024</td>
                  <td>Volt Vault</td>
                  <td>Local Sale</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV844</a></td>
                  <td>25 Oct 2024</td>
                  <td>Elite Retail</td>
                  <td>Service Fees</td>
                  <td>Services that have been verified</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV843</a></td>
                  <td>14 Oct 2024</td>
                  <td>Prime Mart</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV842</a></td>
                  <td>03 Oct 2024</td>
                  <td>NeoTech Store</td>
                  <td>Foreign investment</td>
                  <td>Services that have been verified</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV841</a></td>
                  <td>20 Sep 2024</td>
                  <td>Urban Mart</td>
                  <td>Product Export</td>
                ...
                <tr>
                  <td><a href="#" class="text-orange">INV840</a></td>
                  <td>10 Sep 2024</td>
                  <td>Travel Mart</td>
                  <td>Return/Refund Income</td>
                  <td>Services that have been verified</td>
