                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <vue-select :options="Lenvopad" v-model="selectedOne" placeholder="All" />
                    </div>
                  </div>
                </div>
              </div>
  ...
  data() {
    return {
      ...
      Lenvopad: [
        ...
        {label: "Aamzon Echo Dot", value: "Aamzon Echo Dot"},
        {label: "Red Premium Stachel", value: "Red Premium Stachel"},
      ],
    };
  },
  setup() {
