                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="mb-3">
                      ...
                      <vue-select :options="ServCate" v-model="selected" placeholder="All" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="mb-3">
                      <label class="form-label">Payment Method</label>
                      <vue-select :options="PayCred" v-model="selectedOne" placeholder="All" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="mb-3">
                      <label class="form-label">Status</label>
                      <vue-select :options="PendSat" v-model="selectedTwo" placeholder="All" />
                    </div>
                  </div>
                </div>
              </div>
  ...
  data() {
    return {
      ...
      ServCate: [
        ...
        {label: "Stationery Purchase", value: "Stationery Purchase"},
