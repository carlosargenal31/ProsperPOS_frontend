<template>
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 mb-2 mb-md-0" v-for="(image, index) in galleryImages" :key="index"
          @click="() => show(index)">
                <a href="javascript:;" class="image-popup-desc fancystyle" data-fancybox="gallery"
                    data-title="Title 01" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
