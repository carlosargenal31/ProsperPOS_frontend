    ...
    <div :data-layout="layoutType">
        ...
        <div class="content">
            ...
            <div>
                ...
                ><i class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product</span
                >
            ...
            <div class="col-xxl-8 col-xl-7 col-sm-12 col-12 d-flex">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="tab-pane fade" id="sale-day">
                        ...
                        <div class="border p-2 br-8">
                            <p class="d-inline-flex align-items-center mb-1">
                            <i class="ti ti-circle-filled fs-8 text-primary me-1"></i>Total
                            Sales
                            </p>
                            <h4>1K</h4>
                        </div>
            ...
            <div class="col-xxl-4 col-md-6 d-flex">
                ...
                <div class="card-body sell-product">
                    ...
                    <span
                        ...
                        ><i class="ti ti-arrow-down-left me-1"></i>21%</span
                    >
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
            ...
            <div class="col-xxl-4 col-md-12 d-flex">
                ...
                <div class="card-body">
                    ...
                    <div class="text-end">
                        ...
                        ><i class="ti ti-circle-filled fs-5 me-1"></i>Processing</span
                        >
                    </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="text-end">
                        ...
                        ><i class="ti ti-circle-filled fs-5 me-1"></i>Cancelled</span
                        >
                    </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="text-end">
                        ...
                        ><i class="ti ti-circle-filled fs-5 me-1"></i>Onhold</span
                        >
                    </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="text-end">
                        ...
                        <span
                        class="badge badge-success badge-xs d-inline-flex align-items-center"
                        ><i class="ti ti-circle-filled fs-5 me-1"></i>Completed</span
                        >
                    </div>
                    </div>
                </div>
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="border p-2 br-8">
                        ...
                        $48,988,078<span
                            ...
                            ><i class="ti ti-arrow-down-right me-1"></i>25%</span
                        >
                        </h5>
                        <p>Expense</p>
                    </div>
                        ...
                        <table class="table table-borderless custom-table">
                            ...
                            <tr>
                                ...
                                <span
                                    ...
                                    ><i class="ti ti-circle-filled fs-5 me-1"></i>Draft</span
                                >
                                </td>
                                <td class="fs-16 fw-bold text-gray-9">$4,560</td>
                            </tr>
                    ...
                    <div class="tab-pane" id="quotation">
                        ...
                        <table class="table table-borderless custom-table">
                            ...
                            <tr>
                                ...
                                <span
                                    class="badge badge-success badge-xs d-inline-flex align-items-center"
                                    ><i class="ti ti-circle-filled fs-5 me-1"></i>Sent</span
                                >
                                </td>
                            ...
                            <tr>
                                ...
                                <span
                                    ...
                                    ><i class="ti ti-circle-filled fs-5 me-1"></i>Ordered</span
                                >
                                </td>
                    ...
                    <div class="tab-pane" id="invoices">
                        ...
                        <table class="table table-borderless custom-table">
                            ...
                            <tr>
                                ...
                                <span
                                    class="badge badge-warning badge-xs d-inline-flex align-items-center"
                                    ><i class="ti ti-circle-filled fs-5 me-1"></i>Overdue</span
                                >
                                </td>
...
export default {
    ...
    const layoutType = computed(() => {
      return route.path === "/layouts/layout-boxed" ? "default" : "";
    });

    // Compute the width type (data-width attribute)
    const layoutWidth = computed(() => {
      return route.path === "/layouts/layout-boxed" ? "box" : "default";
    });
    ...
    const updateHtmlAndBody = () => {
      ...
      if (route.path === "/layouts/layout-boxed") {
