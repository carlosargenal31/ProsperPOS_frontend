<template>
  <layout-rtl-header></layout-rtl-header>
  ...
  <div class="page-wrapper">
      ...
      <div class="alert bg-orange-transparent alert-dismissible fade show mb-4">
        <div>
          <span class="d-inline-flex align-items-center"
            ><i class="ti ti-info-circle fs-14 text-orange ms-2"></i>Your Product</span
          >
              ...
              <div class="me-2">
                ...
                <div class="d-inline-flex align-items-center flex-wrap gap-2">
                  ...
                  <span class="badge badge-soft-primary"
                    ><i class="ti ti-arrow-up ms-1"></i>+22%</span
                  >
                </div>
              </div>
            </div>
              ...
              <div class="me-2">
                ...
                <div class="d-inline-flex align-items-center flex-wrap gap-2">
                  ...
                  <span class="badge badge-soft-danger"
                    ><i class="ti ti-arrow-down ms-1"></i>-22%</span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="card flex-fill">
            <div class="card-header d-flex justify-content-between align-items-center">
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-primary fs-16 ms-2"
                  ><i class="ti ti-shopping-cart"></i
                ></span>
                <h5 class="card-title mb-0">Sales & Purchase</h5>
              </div>
              <ul class="nav nav-tabs days-tab">
                <li class="nav-item">
                  <a class="nav-link" href="#sale-day" data-bs-toggle="tab">1D</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#sale-week" data-bs-toggle="tab">1W</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#sale-month" data-bs-toggle="tab">1M</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#quarter-year" data-bs-toggle="tab">3M</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#half-year" data-bs-toggle="tab">6M</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="#year" data-bs-toggle="tab">1Y</a>
                </li>
              </ul>
            </div>
            <div class="card-body pb-0">
              <div class="tab-content">
                <div class="tab-pane fade" id="sale-day">
                  <div class="d-flex align-items-center gap-2">
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary-300 ms-1"></i
                        >Total Purchase
                      </p>
                      <h4>3K</h4>
                    </div>
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary ms-1"></i>Total
                        Sales
                      </p>
                      <h4>1K</h4>
                    </div>
                ...
                <div class="tab-pane fade" id="sale-week">
                  <div class="d-flex align-items-center gap-2">
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary-300 ms-1"></i
                  ...
                  <div id="sales-weekchart">
                    <apexchart
                      type="bar"
                      height="245"
                      :options="salesWeekchart.sline"
                      :series="salesWeekchart.series"
                    ></apexchart>
                  </div>
                </div>
                <div class="tab-pane fade" id="sale-month">
                  <div class="d-flex align-items-center gap-2">
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary-300 ms-1"></i
                  ...
                  <div id="sales-monthchart">
                    <apexchart
                      type="bar"
                      height="245"
                      :options="salesMonthchart.sline"
                      :series="salesMonthchart.series"
                    ></apexchart>
                  </div>
                </div>
                <div class="tab-pane fade" id="quarter-year">
                  <div class="d-flex align-items-center gap-2">
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary-300 ms-1"></i
                  ...
                  <div id="sales-quarterchart">
                    <apexchart
                      type="bar"
                      height="245"
                      :options="salesQuarterchart.sline"
                      :series="salesQuarterchart.series"
                    ></apexchart>
                  </div>
                </div>
                <div class="tab-pane fade" id="half-year">
                  <div class="d-flex align-items-center gap-2">
                    <div class="border p-2 br-8">
                      <p class="d-inline-flex align-items-center mb-1">
                        <i class="ti ti-circle-filled fs-8 text-primary-300 ms-1"></i
                ...
                <div class="tab-pane show active" id="year">
                  ...
                  <div id="sales-purchase">
                    <apexchart
                      type="bar"
                      height="245"
                      :options="salesPurchase.sline"
                      :series="salesPurchase.series"
                    ></apexchart>
                  </div>
                </div>
              </div>
        ...
        <div class="col-xxl-4 col-xl-5 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-info fs-16 ms-2"
                    ...
                    <div class="col-sm-6">
                      <div class="text-center border-end">
                        ...
                        <span
                          ...
                          ><i class="ti ti-arrow-up-left ms-1"></i>25%</span
                        >
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="text-center">
                        ...
                        <span
                          class="badge badge-success badge-xs d-inline-flex align-items-center"
                          ><i class="ti ti-arrow-up-left ms-1"></i>21%</span
                        >
                      </div>
                    </div>
                  </div>
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6 d-flex">
          <div class="card flex-fill">
            ...
            >
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-pink fs-16 ms-2"
                  ><i class="ti ti-box"></i
                ></span>
            ...
            <div class="card-body sell-product">
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Charger Cable - Lighting</a>
                    </h6>
                ...
                <span
                  class="badge bg-outline-success badge-xs d-inline-flex align-items-center"
                  ><i class="ti ti-arrow-up-left ms-1"></i>25%</span
                >
              </div>
              <div
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Yves Saint Eau De Parfum</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>$145</p>
                      <p>289+ Sales</p>
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Apple Airpods 2</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>$458</p>
                      <p>300+ Sales</p>
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Vacuum Cleaner</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>$139</p>
                      <p>225+ Sales</p>
                ...
                <span
                  class="badge bg-outline-danger badge-xs d-inline-flex align-items-center"
                  ><i class="ti ti-arrow-down-left ms-1"></i>21%</span
                >
              </div>
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Samsung Galaxy S21 Fe 5g</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>$898</p>
                      <p>365+ Sales</p>
        ...
        <div class="col-xxl-4 col-md-6 d-flex">
          <div class="card flex-fill">
            ...
            >
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-danger fs-16 ms-2"
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Vacuum Cleaner Robot</a>
                    </h6>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">KitchenAid Stand Mixer</a>
                    </h6>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Levi's Trucker Jacket</a>
                    </h6>
              ...
              <div class="d-flex align-items-center justify-content-between mb-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Lay's Classic</a>
                    </h6>
            ...
            >
              ...
              <div class="dropdown">
                <a
                  ...
                  aria-expanded="false"
                >
                  <i class="ti ti-calendar ms-1"></i>Weekly
                </a>
                <ul class="dropdown-menu p-3">
                  <li>
                    <a href="javascript:void(0);" class="dropdown-item">Today</a>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="text-end">
                  ...
                  <span class="badge bg-purple badge-xs d-inline-flex align-items-center"
                    ><i class="ti ti-circle-filled fs-5 ms-1"></i>Processing</span
                  >
                </div>
              </div>
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Gold Bracelet</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>Fashion</p>
                ...
                <div class="text-end">
                  <p class="fs-13 mb-1">Today</p>
                  <span
                    class="badge badge-danger badge-xs d-inline-flex align-items-center"
                    ><i class="ti ti-circle-filled fs-5 ms-1"></i>Cancelled</span
                  >
                </div>
              </div>
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Parachute Down Duvet</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>Health</p>
                ...
                <div class="text-end">
                  ...
                  <span class="badge badge-cyan badge-xs d-inline-flex align-items-center"
                    ><i class="ti ti-circle-filled fs-5 ms-1"></i>Onhold</span
                  >
                </div>
              </div>
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">YETI Rambler Tumbler</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>Sports</p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    <h6 class="fw-medium mb-1">
                      <a href="javascript:void(0);">Osmo Genius Starter Kit</a>
                    </h6>
                    <div class="d-flex align-items-center item-list">
                      <p>Lifestyles</p>
                ...
                <div class="text-end">
                  ...
                  <span
                    class="badge badge-success badge-xs d-inline-flex align-items-center"
                    ><i class="ti ti-circle-filled fs-5 ms-1"></i>Completed</span
                  >
                </div>
              </div>
            </div>
      ...
      <div class="row">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <div class="dropdown">
                <a
                  ...
                  aria-expanded="false"
                >
                  <i class="ti ti-calendar ms-1"></i>2025
                </a>
                <ul class="dropdown-menu p-3">
                  <li>
              ...
              <div class="d-flex align-items-center flex-wrap gap-2">
                <div class="border p-2 br-8">
                  <h5 class="d-inline-flex align-items-center text-teal">
                    $12,189<span
                      class="badge badge-success badge-xs d-inline-flex align-items-center ms-2"
                      ><i class="ti ti-arrow-up-left ms-1"></i>25%</span
                    >
                  </h5>
                  <p>Revenue</p>
                ...
                <div class="border p-2 br-8">
                  <h5 class="d-inline-flex align-items-center text-orange">
                    $48,988,078<span
                      class="badge badge-danger badge-xs d-inline-flex align-items-center ms-2"
                      ><i class="ti ti-arrow-down-right ms-1"></i>25%</span
                    >
                  </h5>
                  <p>Expense</p>
                </div>
        ...
        <div class="col-xl-6 col-sm-12 col-12 d-flex">
          <div class="card flex-fill">
            ...
            >
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-orange fs-16 ms-2"
            ...
            <div class="card-body p-0">
              <ul class="nav nav-tabs nav-justified transaction-tab">
                <li class="nav-item">
                  <a class="nav-link active" href="#sale" data-bs-toggle="tab">Sale</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#purchase-transaction" data-bs-toggle="tab"
                    >Purchase</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#quotation" data-bs-toggle="tab">Quotation</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#expenses" data-bs-toggle="tab">Expenses</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#invoices" data-bs-toggle="tab">Invoices</a>
                </li>
              </ul>
              <div class="tab-content">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center file-name-icon">
                              ...
                              <div class="me-2">
                                <h6 class="fw-medium">
                                  <a href="javascript:void(0);">Andrea Willer</a>
                                </h6>
                          ...
                          <td>
                            <span
                              class="badge badge-success badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i
                              >Completed</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center file-name-icon">
                              ...
                              <div class="me-2">
                                <h6 class="fw-medium">
                                  <a href="javascript:void(0);">Timothy Sandsr</a>
                                </h6>
                                <span class="fs-13 text-orange">#114589</span>
                              </div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center file-name-icon">
                              ...
                              <div class="me-2">
                                <h6 class="fw-medium">
                                  <a href="javascript:void(0);">Bonnie Rodrigues</a>
                                </h6>
                                <span class="fs-13 text-orange">#114589</span>
                              </div>
                            </div>
                          ...
                          <td>
                            <span
                              class="badge badge-pink badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Draft</span
                            >
                          </td>
                          <td class="fs-16 fw-bold text-gray-9">$4,560</td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center file-name-icon">
                              ...
                              <div class="me-2">
                                <h6 class="fw-medium">
                                  <a href="javascript:void(0);">Randy McCree</a>
                                </h6>
                                <span class="fs-13 text-orange">#114589</span>
                              </div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center file-name-icon">
                              ...
                              <div class="me-2">
                                <h6 class="fw-medium">
                                  <a href="javascript:void(0);">Dennis Anderson</a>
                                </h6>
                                <span class="fs-13 text-orange">#114589</span>
                              </div>
                            </div>
                    ...
                    <table class="table table-borderless custom-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-cyan badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Pending</span
                            >
                          </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-success badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Sent</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-warning badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Ordered</span
                            >
                          </td>
                    ...
                    <table class="table table-borderless custom-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <h6 class="fw-medium">
                              <a href="javascript:void(0);">Electricity Payment</a>
                            </h6>
                          ...
                          <td>
                            <span
                              class="badge badge-success badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Approved</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 class="fw-medium">
                              <a href="javascript:void(0);">Stationery Purchase</a>
                            </h6>
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 class="fw-medium">
                              <a href="javascript:void(0);">AC Repair Service</a>
                            </h6>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-warning badge-xs d-inline-flex align-items-center"
                              ><i class="ti ti-circle-filled fs-5 ms-1"></i>Overdue</span
                            >
                          </td>
      ...
      <div class="row">
                  ...
                  <div class="me-2">
                    ...
                    <div class="d-flex align-items-center item-list">
                      <p class="d-inline-flex align-items-center">
                        <i class="ti ti-map-pin ms-1"></i>USA
                      </p>
                      <p>24 Orders</p>
                    </div>
                  </div>
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    ...
                    <div class="d-flex align-items-center item-list">
                      <p class="d-inline-flex align-items-center">
                        <i class="ti ti-map-pin ms-1"></i>UAE
                      </p>
                      <p>22 Orders</p>
                    </div>
                  </div>
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    ...
                    <div class="d-flex align-items-center item-list">
                      <p class="d-inline-flex align-items-center">
                        <i class="ti ti-map-pin ms-1"></i>Germany
                      </p>
                      <p>14 Orders</p>
                    </div>
                  </div>
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    ...
                    <div class="d-flex align-items-center item-list">
                      <p class="d-inline-flex align-items-center">
                        <i class="ti ti-map-pin ms-1"></i>Belgium
                      </p>
                      <p>08 Orders</p>
                    </div>
                  </div>
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2">
                    ...
                    <div class="d-flex align-items-center item-list">
                      <p class="d-inline-flex align-items-center">
                        <i class="ti ti-map-pin ms-1"></i>Greenland
                      </p>
                      <p>14 Orders</p>
                    </div>
                  </div>
                ...
                <div>
                  <div class="category-item category-primary">
                    ...
                    <h2 class="d-flex align-items-center">
                      698<span class="fs-13 fw-normal text-default me-1">Sales</span>
                    </h2>
                  </div>
                  <div class="category-item category-orange">
                    <p class="fs-13 mb-1">Sports</p>
                    <h2 class="d-flex align-items-center">
                      545<span class="fs-13 fw-normal text-default me-1">Sales</span>
                    </h2>
                  </div>
                  <div class="category-item category-secondary">
                    <p class="fs-13 mb-1">Lifestyles</p>
                    <h2 class="d-flex align-items-center">
                      456<span class="fs-13 fw-normal text-default me-1">Sales</span>
                    </h2>
                  </div>
                </div>
              </div>
              ...
              <div class="border br-8">
                ...
                >
                  <p class="d-inline-flex align-items-center mb-0">
                    <i class="ti ti-square-rounded-filled text-indigo fs-8 ms-2"></i>Total
                ...
                <div class="d-flex align-items-center justify-content-between p-2">
                  <p class="d-inline-flex align-items-center mb-0">
                    <i class="ti ti-square-rounded-filled text-orange fs-8 ms-2"></i>Total
                    Number Of Products
                  </p>
                  <h5>7899</h5>
                </div>
        ...
        <div class="col-xxl-4 col-md-12 d-flex">
          <div class="card flex-fill">
            ...
            >
              <div class="d-inline-flex align-items-center">
                <span class="title-icon bg-soft-indigo fs-16 ms-2"
    ...
    >
      <p class="fs-13 text-gray-9 mb-0">
        {{ new Date().getFullYear() }} © DreamsPOS. All Right Reserved
      </p>
      <p>
        Designed & Developed By Dreams
        <a href="javascript:void(0);" class="link-primary">Dreams</a>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      salesWeekchart: salesWeekchart,
      salesMonthchart: salesMonthchart,
      salesQuarterchart: salesQuarterchart,
      salesHalfchart: salesHalfchart,
