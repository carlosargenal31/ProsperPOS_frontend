        ...
        <div class="col-md-12 col-lg-8">
          <div class="pos-categories tabs_wrapper">
            ...
            <ul class="tabs owl-carousel pos-category">
              ...
              >
                <Slide v-for="item in POS" :key="item.id">
                  <li :id="item.Name">
                  ...
                  <div class="row">
                    <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3">
                      <div class="product-info default-cover card">
                        <a href="javascript:void(0);" class="img-bg">
                          ...
                          />
                          <span
                            ><vue-feather type="check" class="feather-16"></vue-feather
                          ></span>
                        </a>
                        <h6 class="cat-name">
                    ...
                    <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                      <div class="product-info default-cover card">
                        ...
                        <h6 class="product-name">
                          <a href="javascript:void(0);">Fossil Pair Of 3 in 1 </a>
                        </h6>
                        <div
                          class="d-flex align-items-center justify-content-between price"
                        >
          ...
          <aside class="product-order-list">
            ...
            <div class="customer-info block-section">
              ...
              <div class="input-block">
                <vue-select :options="Airpod" v-model="selectedOne" placeholder="Search Products" />
              </div>
            </div>
                ...
                >
                  ...
                  <div class="qty-item text-center">
                    <a
                      ...
                      title="minus"
                      ><vue-feather type="minus-circle" class="feather-14"></vue-feather
                    ></a>
                    <input
                      type="text"
                    ...
                    <a
                      ...
                      data-bs-placement="top"
                      title="plus"
                      ><vue-feather type="plus-circle" class="feather-14"></vue-feather
                    ></a>
                  </div>
                ...
                <div class="row">
                  <div class="col-12 col-sm-4">
                    <div class="input-block">
                      ...
                      <vue-select :options="GST" v-model="selectedTwo" placeholder="GST 5%" />
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="input-block">
                      <label>Shipping</label>
                      <vue-select :options="Shipping" v-model="selectedThree" placeholder="15" />
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="input-block">
                      <label>Discount</label>
                      <vue-select :options="Discount" v-model="selectedFour" placeholder="10%" />
                    </div>
                  </div>
                </div>
              </div>
