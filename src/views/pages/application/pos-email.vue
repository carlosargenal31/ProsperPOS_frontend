<template>
              ...
              <div class="slimscroll-active-sidebar">
                <div class="p-3">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="d-block mb-4 pb-4 border-bottom email-tags">
                      ...
                      >
                        ...
                        >
                        <span class="badge shadow-none badge-danger rounded-pill badge-xs"
                          >56</span
                        >
                      </router-link>
                      <a
                        ...
                        <div class="more-menu">
                          ...
                          >
                            <span class="d-flex align-items-center fw-medium"
                              ...
                              >Important</span
                            >
                            <span class="badge shadow-none text-gray rounded-pill"
                              >12</span
                            >
                          </a>
                          <a
                  ...
                  <div class="border-bottom mb-4 pb-4">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                      ...
                      <a href="javascript:void(0);"
                        ><i
                          class="ti ti-square-rounded-plus-filled text-primary fs-16"
                        ></i
                      ></a>
                    </div>
                    <div>
                  ...
                  <div class="bg-dark rounded text-center position-relative p-4">
                    ...
                    <a
                      href="javascript:void(0);"
                      class="btn btn-white position-relative z-1"
              ...
              <div class="list-group list-group-flush mails-list">
                <div class="list-group-item border-bottom p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div
                      class="d-flex align-items-center flex-wrap row-gap-2 flex-fill"
                    >
                      <router-link
                        to="/application/email-reply"
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="mb-1">
                              <router-link to="/application/email-reply"
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <span class="badge shadow-none badge-soft-info mx-2"
                ...
                <div class="list-group-item border-bottom p-3">
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <span
                              ><i class="ti ti-point-filled text-danger"></i>3:13
                              PM</span
                            >
                          </div>
                        </div>
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span><i class="ti ti-star-filled text-warning"></i></span>
                      <span class="badge shadow-none badge-soft-purple mx-2"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span><i class="ti ti-star-filled text-warning"></i></span>
                      <span class="badge shadow-none badge-soft-danger mx-2"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span class="badge shadow-none badge-soft-success"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span class="badge shadow-none badge-soft-danger me-2"
                        ><i class="ti ti-square me-1"></i>External</span
                      >
                      <a
                        href="javascript:void(0);"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span class="badge shadow-none badge-soft-warning me-2"
                ...
                <div class="list-group-item border-bottom p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span class="badge shadow-none badge-soft-info shadow-none"
                        ><i class="ti ti-square me-1"></i>Projects</span
                      >
                    </div>
                  </div>
  ...
  <!-- Compose Mail -->
  <div id="compose-view" ref="composeView" class="modal">
...
export default {
  ...
  methods: {
    ...
    openModal() {
      ...
      // Show the modal
      if (this.composeView) {
        this.composeView.classList.add("show");
      }
    },
    closeModal() {
      // Remove the backdrop
      ...
      // Hide the modal
      if (this.composeView) {
        this.composeView.classList.remove("show");
      }
    },
  },

  mounted() {
    this.composeView = this.$refs.composeView;
  },
};
</script>
