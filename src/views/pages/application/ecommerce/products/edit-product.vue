...
export default {
  data() {
    return {
      ...
      selectedTen: "Replacement Warranty",
      Store: [
  ...
  methods: {
    submitForm() {
      this.$router.push("/ecommerce/edit-product");
    },
    initQuill() {
