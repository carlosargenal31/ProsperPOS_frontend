        ...
        <div class="card">
          <div class="card-body add-product pb-0">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-12">
                        <div class="mb-3 add-product">
                          ...
                          >
                          <vue-select :options="Store" v-model="selected" placeholder="Choose" />
                        </div>
                      </div>
                      <div class="col-sm-6 col-12">
                        <div class="mb-3 add-product">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-12">
                          <div class="mb-3 add-product">
                            ...
                            <vue-select :options="Unit" v-model="selectedSix" placeholder="Choose" />
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="accordion-card-one accordion" id="accordionExample2">
              <div class="accordion-item pricing-accordion">
                ...
                <div class="accordion-header" id="headingThree">
                  ...
                  >
                    <div class="addproduct-icon list">
                      <h5>
                        <i data-feather="image" class="add-info"></i><span>Images</span>
                      </h5>
                      <a href="javascript:void(0);"
                        ><i data-feather="chevron-down" class="chevron-down-add"></i
                      ></a>
                    ...
                    <div class="text-editor add-list add">
                      ...
                      <div class="row">
                        <div class="col-sm-6 col-12">
                          <div class="mb-3 add-product">
                            <label class="form-label"
                              >Warranty<span class="text-danger ms-1">*</span></label
                            >
                            <vue-select
                              :options="Warranty"
                              v-model="selectedTen"
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/ecommerce/add-product");
    },
    initQuill() {
