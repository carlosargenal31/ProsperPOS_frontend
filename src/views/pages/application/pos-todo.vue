        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <router-link to="/application/todo" class="todo-grid-view active"><i class="feather feather-grid"></i></router-link>
                    </li>
                    <li>
                        <router-link to="/application/todo-list" class="todo-list-view"><i class="feather feather-list"></i></router-link>
                    </li>
                    <li>
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i class="feather feather-rotate-ccw"></i></a>
                    </li>
                    <li>
                ...
                <div class="page-btn">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#note-units"><i class="feather feather-plus-circle me-2"></i>Create New</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <button class="btn bg-primary-transparent border-dashed border-primary w-100 text-start" data-bs-toggle="modal" data-bs-target="#note-units">
                                    ...
                                    <div class="row align-items-center mb-3 row-gap-3">
                                        ...
                                        <div class="col-lg-8 col-sm-6">
                                            <div class="d-flex align-items-center justify-content-sm-end">
                                                <a href="#" class="btn btn-light me-2" data-bs-toggle="modal" data-bs-target="#note-units"><i class="ti ti-circle-plus me-2"></i>Add New</a>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-md-end flex-wrap row-gap-3">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="dropdown ms-2">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                                                            <li>
                                                                                <a href="javascript:void(0);" class="dropdown-item rounded-1" data-bs-toggle="modal" data-bs-target="#edit-note-units"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                            </li>
                                                                            <li>
                                            ...
                                            <div class="list-group list-group-flush">
                                                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                                                    <div class="row align-items-center row-gap-3">
                                                        <div class="col-lg-6 col-md-7">
                                                            <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                                                                :class="{ 'todo-strike-content': isClickedTwele }"
                                                                @click="toggleClickedTwele">
                                                                <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                                                                <div class="form-check form-check-md me-2">
                                                                    <input class="form-check-input" type="checkbox">
                                                                </div>
                                                ...
                                                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                                                    <div class="row align-items-center row-gap-3">
                                                        <div class="col-lg-6 col-md-7">
                                                            <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3" 
                                                                :class="{ 'todo-strike-content': isClickedThirteen }"
                                                                @click="toggleClickedThirteen">
                                                                <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                                                                <div class="form-check form-check-md me-2">
                                                                    <input class="form-check-input" type="checkbox">
                                                                </div>
                                            ...
                                            <div class="list-group list-group-flush">
                                                <div class="list-group-item list-item-hover shadow-sm rounded mb-2 p-3">
                                                    <div class="row align-items-center row-gap-3">
                                                        <div class="col-lg-6 col-md-7">
                                                            <div class="todo-inbox-check d-flex align-items-center flex-wrap row-gap-3"
                                                                :class="{ 'todo-strike-content': isClickedFourteen }"
                                                                @click="toggleClickedFourteen">
                                                                <span class="me-2 d-flex align-items-center"><i class="ti ti-grid-dots text-dark"></i></span>
                                                                <div class="form-check form-check-md me-2">
                                                                    <input class="form-check-input" type="checkbox">
                                                                </div>
...
export default {
    data(){
        return{
            ...
            isClickedEight: false,
            isClickedNine: false,
            isClickedTen: false,
            isClickedEleven: true,
            isClickedTwele: false,
            isClickedThirteen: false,
            isClickedFourteen: false,
        }
    },
    methods: {
        toggleHeader() {
        ...
        toggleClickedTwele() {
            this.isClickedTwele = !this.isClickedTwele;
        },
        toggleClickedThirteen() {
            this.isClickedThirteen = !this.isClickedThirteen;
        },
        toggleClickedFourteen() {
            this.isClickedFourteen = !this.isClickedFourteen;
        },
    },
}
</script>