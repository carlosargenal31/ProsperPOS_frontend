  ...
  <div class="notes-slider owl-carousel">
    <Carousel :wrap-around="true" :settings="settings" :breakpoints="breakpoints">
      <Slide v-for="item in NotesCarousel" :key="item.id">
        <div class="card rounded-3 mb-0 me-2">
          <div class="card-body p-4">
            ...
            <div class="text-start my-3">
              <h5 class="text-truncate mb-1"><a
                  href="javascript:void(0);">{{item.Title}}</a></h5>
              <p class="mb-3 d-flex align-items-center text-dark"><i
                  class="ti ti-calendar me-1"></i>{{item.Date}}</p>
              <p class="text-truncate line-clamb-2 text-wrap">{{item.Content}}</p>
            </div>
            <div
