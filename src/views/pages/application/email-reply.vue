            ...
            <simplebar id="scrollbar" class="h-100" ref="scrollbar">
              <div class="slimscroll-active-sidebar">
                ...
                <div class="bg-light-500 rounded p-3 mb-3">
                  <div
                    class="d-flex align-items-center flex-fill border-bottom mb-3 pb-3"
                  >
                    <a
                      href="javascript:void(0);"
                ...
                <div class="card shadow-none">
                  <div class="card-body">
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                      <a class="dropdown-item" href="javascript:void(0);"
                                        ><span class="text-gray">Date :</span> 12 May
                                        2025, 09:45 PM
                                      </a>
                                    </li>
                                  </ul>
                    ...
                    <div>
                      ...
                      <p class="text-dark">
                        Best regards <br /><b class="fw-medium d-inline-flex mt-1"
                          >Arman</b
                        >
                      </p>
                    </div>
                      ...
                      <div class="border rounded mt-3">
                        <div class="p-3 position-relative pb-2 border-bottom">
                          ...
                          <div class="d-flex align-items-center email-cc">
                            <a href="javascript:void(0);" class="d-inline-flex me-2"
                              >Cc</a
                            >
