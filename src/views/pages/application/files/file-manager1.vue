          ...
          <div class="border-bottom mb-4">
            ...
            <div class="owl-carousel video-section">
              <div class="video-wrap">
                ...
                <div
                  class="d-flex align-items-center justify-content-between video-content"
                >
                  <h6 class="fw-medium">
                  ...
                  <div class="ms-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <p class="fs-12 mb-0 d-flex align-items-center">
                        <i class="ti ti-circle-filled fs-6 me-2 text-title"></i>135 files
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <p class="fs-12 mb-0 d-flex align-items-center">
                        <i class="ti ti-circle-filled fs-6 me-2 text-title"></i>15 files
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <p class="fs-12 mb-0 d-flex align-items-center">
                        <i class="ti ti-circle-filled fs-6 me-2 text-title"></i>115 files
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="border-bottom mb-4">
            ...
            <div class="owl-carousel files-carousel">
              <div class="files-wrap">
                <div
                  class="bg-secondary-transparent p-5 d-flex align-items-center justify-content-center files-icon"
                >
              ...
              <div class="files-wrap">
                ...
                <div
                  class="bg-white d-flex align-items-center justify-content-between p-3 files-content"
                >
                  <h6 class="fw-medium text-truncate">
                    <a href="#" data-bs-toggle="offcanvas" data-bs-target="#preview"
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/application/file-manager");
    },
  },
};
</script>
