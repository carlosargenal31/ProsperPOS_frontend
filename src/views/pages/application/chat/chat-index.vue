    ...
    <div class="content">
      ...
      <div class="chat-wrapper">
        ...
        <div class="sidebar-group">
          <div id="chats" class="sidebar-content active slimscroll flex-fill">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3">
                      ...
                      <li>
                        <a href="#" class="dropdown-item"
                          ><i class="ti ti-clock-hour-4 me-2"></i>Disappearing Message</a
                        >
                      </li>
                      <li>
                        <a href="#" class="dropdown-item"
              ...
              <div class="messages">
                ...
                <div class="chats">
                  ...
                  <div class="chat-content">
                    <div class="chat-info">
                      <div class="message-content">
                        Hi Mark, good to hear from you! Your delivery is scheduled for
                    ...
                    <div class="chat-profile-name">
                      <h6>
                        ...
                        ><span class="chat-time">08:00 AM</span
                        ><i class="ti ti-checks text-success ms-2"></i>
                      </h6>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="chat-content">
                    <div class="chat-info">
                      <div class="message-content">
                        ...
                        <ul>
                          <li>
                            <i class="ti ti-point-filled"></i> 20 cases of bottled water
                            (500ml)
                          </li>
                          <li>
                            <i class="ti ti-point-filled"></i>15 cartons of eggs (12 pcs
                            each)
                          </li>
                        </ul>
                ...
                <div class="chats chats-right">
                  <div class="chat-content">
                    <div class="chat-info">
                      <div class="message-content">
                        Almost. Can you increase the bottled water to 30 cases instead
                        of 20?
                        <div class="emoj-group">
                          <ul>
                            <li class="emoj-action">
                ...
                <div class="chats">
                  ...
                  <div class="chat-content">
                    <div class="chat-info">
                      <div class="message-content">
                        Got it! I’ll update the order to 30 cases of bottled water.
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/application/chat");
    },
    toggleHeader() {
