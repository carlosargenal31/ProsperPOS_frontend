            ...
            <div class="group-avatar">
              <span class="avatar">
                <a
                  ...
                  ><img :src="getImageUrl(item.Image)" alt="Avatar"
                /></a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img :src="getImageUrl(item.Image_Two)" alt="Avatar"/>
              </a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img :src="getImageUrl(item.Image_Three)" alt="Avatar" key=""/>
                 </a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img :src="getImageUrl(item.Image_Four)" alt="Avatar" />
                  </a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img :src="getImageUrl(item.Image_Five)"/>
                </a>
              </span>
              <span class="count">
