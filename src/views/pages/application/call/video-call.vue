    ...
    <div class="page-wrapper">
        <div class="content mb-3">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="#" class="btn btn-primary"><i class="feather feather-plus-circle me-2"></i>Add People</a>
                </div>
            </div>
                    ...
                    <div class="single-video d-flex">
                        <div class="join-video flex-fill">
                            ...
                            <div class="call-overlay-bottom d-flex justify-content-sm-between align-items-center flex-wrap w-100">
                                ...
                                <a href="javascript:void(0);" @click="handleShowMessageClick" class="options-icon bg-light d-flex align-items-center justify-content-center rounded" id="show-message"><i class="ti ti-dots"></i></a>
                            </div>
                        </div>
                        <div class="right-user-side chat-rooms" id="chat-room" ref="chatRooms" :class="{ 'open-chats': isOpenMessage }">
                            <div class="card slime-grp border-0 mb-0">
                                <div class="card-header p-3 pb-0 border-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5>Chat</h5>
                                        <a href="#" @click="handleCloseProfileClick" class="close_profile close_profile4 avatar avatar-sm mb-0 rounded-circle bg-danger">
                                            <i class="ti ti-x"></i>
                                        </a>
                                    </div>
                                </div>
