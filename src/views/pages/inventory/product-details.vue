      ...
      <div class="page-header">
        <div class="add-item d-flex">
          <div class="page-title">
            <h4 class="fw-bold">Visualización de Producto</h4>
        ...
        <div class="page-btn d-flex gap-2">
          <router-link :to="`/inventory/edit-product/${productId}`" class="btn btn-primary">
            <i class="ti ti-edit me-2"></i>Editar Producto
          </router-link>
...
.product-details-view input,
.product-details-view textarea,
.product-details-view select {
  background-color: #f8f9fa !important;
  cursor: not-allowed !important;
  pointer-events: none;
}

.product-details-view .image-upload,
.product-details-view button[type="button"] {
  display: none !important;
}

.product-details-view .form-check-input {
  pointer-events: none;
}
</style>
