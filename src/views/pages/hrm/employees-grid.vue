  ...
  <div class="page-wrapper">
    <div class="content">
      <div class="page-header">
        ...
        <ul class="table-top-head">
          <li>
            <div class="d-flex me-2 pe-2 border-end">
              <router-link to="/hrm/employees-list" class="btn-list me-2"
                ><i data-feather="list" class="feather-list"></i
              ></router-link>
              <router-link to="/hrm/employees-grid" class="btn-grid bg-primary me-2"
                ><i data-feather="grid" class="feather-grid"></i
              ></router-link>
            </div>
          </li>
          <li class="me-2">
        ...
        <div class="page-btn">
          <router-link to="/hrm/add-employee" class="btn btn-primary"
            ><i class="ti ti-circle-plus me-1"></i>Add Employee</router-link
          >
        </div>
      </div>
      <div class="row">
        <div class="col-xl-3 col-md-6">
          <div class="card bg-purple border-0">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="avatar avatar-lg bg-purple-900"
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-teal border-0">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="avatar avatar-lg bg-teal-900"
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-secondary border-0">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="avatar avatar-lg bg-secondary-900"
        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-info border-0">
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="avatar avatar-lg bg-info-900"
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between mb-2">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <router-link to="/hrm/edit-employee" class="dropdown-item"
                          ><i data-feather="edit" class="me-2"></i>Edit</router-link
                        >
                      </li>
                      <li>
                        <a
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Anthony Lewis</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
                </div>
                <div
                  class="d-flex align-items-center justify-content-between bg-light rounded p-3"
                >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Brian Villalobos</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Harvey Smith</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Stephan Peralt</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Doglas Martini</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Linda Ray</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Elliot Murray</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Rebecca Smtih</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Connie Waters</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Lori Broaddus</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Trent Frazier</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="text-center mb-3">
                  <h6 class="mb-1">
                    <router-link to="/hrm/employee-details">Norene Valle</router-link>
                  </h6>
                  <span class="badge bg-secondary-transparent fs-10 fw-medium"
                    >System Admin</span
                  >
