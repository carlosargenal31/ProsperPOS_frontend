      ...
      <div class="row">
        <div class="col-xl-4 col-lg-12 d-flex">
          <div class="card w-100 border-0">
            <div class="card-body">
              <h5
                class="mb-3 pb-3 border-bottom d-flex justify-content-between align-items-center fs-18"
              >
                Attendance<span class="text-purple fs-14">22 Aug 2023</span>
              </h5>
              ...
              <div class="d-flex align-items-center">
                <a href="javascript:void(0);" class="btn btn-primary w-100 me-2"
                  >Clock Out</a
                >
                <a href="javascript:void(0);" class="btn btn-secondary me-2 w-100"
                  >Break</a
                >
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="row gy-3">
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-primary-transparent fw-bold fs-20 mb-2 mx-auto"
                      >31</span
                    >
                    <p class="fs-14">
                      Total Working <br />
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-danger-transparent fw-bold fs-20 mb-2 mx-auto"
                      >05</span
                    >
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-purple-transparent text-purple fw-bold fs-20 mb-2 mx-auto"
                      >28</span
                    >
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-warning-transparent fw-bold fs-20 mb-2 mx-auto"
                      >02</span
                    >
                    <p class="fs-14">
                      Half<br />
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-cyan-transparent text-cyan fw-bold fs-20 mb-2 mx-auto"
                      >01</span
                    >
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 text-center">
                  <div>
                    <span
                      class="d-flex align-items-center justify-content-center avatar avatar-xl bg-success-transparent text-success fw-bold fs-20 mb-2 mx-auto"
                      >02</span
                    >
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>-</td>
                  <td>
                    <div class="progress attendance bg-secondary-transparent"></div>
                  </td>
                  <td>-</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <span
                      class="badge badge-purple d-inline-flex align-items-center badge-xs"
                    >
...
export default {
  data() {
    return {
      ...
      Choosetus: ["Choose Status", "Present", "Absent", "Holiday"],
      AttSort: ["Sort by Date", "Newest", "Oldest"],
    };
  },
  methods: {
    toggleLayoutBox() {
