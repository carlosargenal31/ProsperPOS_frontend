                  ...
                  <td class="action-table-data justify-content-end">
                    <div class="edit-delete-action">
                      <a
                        class="me-2 p-2"
                        href="#"
                        @click.prevent="openViewModal(department)"
                        data-bs-toggle="modal"
                        data-bs-target="#view-department"
                        title="Ver detalles"
                      >
  ...
  methods: {
    ...
    exportToPDF() {
      try {
        ...
        const data = this.departments.map(department => ({
          ...department,
          is_active: department.is_active ? 'Activo' : 'Inactivo'
        }));

        exportPDF(data, columns, 'departamentos-rh', 'Lista de Departamentos');
    ...
    exportToExcel() {
      try {
        ...
        exportExcel(data, columns, 'departamentos-rh', 'Departamentos');
