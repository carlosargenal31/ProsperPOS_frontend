      ...
      <div class="page-header">
        ...
        <ul class="table-top-head">
          <li>
            <div class="d-flex me-2 pe-2 border-end">
              <router-link to="/hrm/department-list" class="btn-list me-2"
                ><i data-feather="list" class="feather-list"></i
              ></router-link>
              <router-link
                to="/hrm/department-grid"
                class="btn-grid active bg-primary me-2"
        ...
        <div class="page-btn">
          <a
            ...
            ><i class="ti ti-circle-plus me-1"></i>Add Department</a
          >
        </div>
      </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Inventory
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a
                          ...
                          ><i data-feather="edit" class="info-img me-2"></i>Edit</a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          ><i data-feather="trash-2" class="info-img me-2"></i>Delete</a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="avatar-list-stacked avatar-group-sm">
                    ...
                    <a
                      class="avatar avatar-rounded text-fixed-white fs-10 fw-medium position-relative"
                      href="javascript:void(0);"
                    >
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Human Resources
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Admin
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Sales
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Marketing
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Quality Assurance
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Finance
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Maintenance
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>R&D
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Content Creation
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>Social Media
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <h5 class="d-inline-flex align-items-center">
                    <i class="ti ti-point-filled text-success fs-20"></i>IT Support
                  </h5>
                  <div class="dropdown">
                    <a
                      href="#"
