      ...
      <div class="page-header">
        ...
        <div class="page-btn d-flex gap-2">
          <a
            ...
            @click="openAddModal"
          >
            <i class="ti ti-circle-plus me-1"></i>Agregar Nuevo Cliente
          </a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Guardar Reporte - Clientes</h5>
  ...
  methods: {
    ...
    async saveAsPDF() {
      ...
      try {
        ...
        pdf.save(`clientes_${new Date().toISOString().split('T')[0]}.pdf`);
    ...
    async saveAsImage() {
      ...
      try {
        ...
        link.download = `clientes_${new Date().toISOString().split('T')[0]}.png`;
    ...
    async buildReportHTML() {
      ...
      const tableRows = this.customers.map(customer => `
        <tr>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${customer.codigo || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${customer.nombre || '-'}</td>
