      ...
      <div class="page-header">
        ...
        <div class="page-btn d-flex gap-2">
          <a
            ...
            @click="openAddModal"
          >
            <i class="ti ti-circle-plus me-1"></i>Agregar Proveedor
          </a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Guardar Reporte - Proveedores</h5>
  ...
  methods: {
    ...
    saveAsExcel() {
      ...
      try {
        ...
        const data = this.sortedSuppliers.map(supplier => ({
          ...
          'Tipo Proveedor': supplier.tipo_proveedor || '-',
          'Doc. Identificación': supplier.doc_identificacion || '-',
          'Tipo Beneficiario': supplier.beneficiary_type_name || '-',
    ...
    async saveAsPDF() {
      ...
      try {
        ...
        pdf.save(`proveedores_${new Date().toISOString().split('T')[0]}.pdf`);
    ...
    async saveAsImage() {
      ...
      try {
        ...
        link.download = `proveedores_${new Date().toISOString().split('T')[0]}.png`;
    ...
    async buildReportHTML() {
      ...
      const tableRows = this.sortedSuppliers.map(supplier => `
        <tr>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${supplier.id}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${supplier.nombre}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${supplier.tipo_proveedor || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${supplier.doc_identificacion || '-'}</td>
          <td style="padding: 6px; border: 1px solid #ddd; font-size: 9px;">${supplier.beneficiary_type_name || '-'}</td>
