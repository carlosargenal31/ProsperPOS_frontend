<template>
  ...
  <div class="header pos-header">
    ...
    <ul class="nav user-menu">
      ...
      >
        <a href="#" data-bs-toggle="modal" data-bs-target="#cash-register"
      ...
      >
        <a href="#" data-bs-toggle="modal" data-bs-target="#today-sale"
      ...
      >
        <a href="#" data-bs-toggle="modal" data-bs-target="#today-profit"
      ...
      >
        <router-link to="/app-settings/pos-settings"
        ...
        <div class="dropdown-menu menu-drop-user">
          <div class="profilename">
            ...
            <router-link class="dropdown-item" to="/pages/profile"
              ><i class="me-2" data-feather="user"></i>My Profile</router-link
            >
            <router-link class="dropdown-item" to="/settings/general-settings"
              ><i class="me-2" data-feather="settings"></i>Settings</router-link
            >
            <hr class="m-0" />
