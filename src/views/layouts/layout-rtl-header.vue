            ...
            <ul class="nav user-menu">
                        ...
                        <form action="#" class="dropdown">
                            <div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="false">
                                ...
                                <span class="input-group-text">
                                    <kbd class="d-flex align-items-center"><img src="@/assets/img/icons/command.svg" alt="img" class="ms-1">K</kbd>
                                </span>
                            </div>
                ...
                <li class="nav-item dropdown link-nav">
                    <a href="javascript:void(0);" class="btn btn-primary btn-md d-inline-flex align-items-center" data-bs-toggle="dropdown">
                        <i class="ti ti-circle-plus ms-1"></i>Add New
                    </a>
                ...
                <li class="nav-item pos-nav">
                    <router-link to="/pos/pos-1" class="btn btn-dark btn-md d-inline-flex align-items-center">
                        <i class="ti ti-device-laptop ms-1"></i>POS
                    </router-link>
                </li>
                ...
                <li class="nav-item dropdown has-arrow main-drop profile-nav">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        ...
                        <router-link class="dropdown-item" to="/pages/profile"><i class="ti ti-user-circle ms-2"></i>MyProfile</router-link>
                        <router-link class="dropdown-item" to="/sales-report/sales-report"><i class="ti ti-file-text ms-2"></i>Reports</router-link>
                        <router-link class="dropdown-item" to="/settings/general-settings"><i class="ti ti-settings-2 ms-2"></i>Settings</router-link>
                        <hr class="my-2">
                        <router-link class="dropdown-item logout pb-0" to="/"><i class="ti ti-logout ms-2"></i>Logout</router-link>
                    </div>
                </li>
            </ul>
            <!-- /Header Menu -->
