<template>
  <!-- View Country -->
  <div class="modal fade" id="view-country" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-body">
              <div class="row" v-if="country">
                ...
                <div class="col-lg-6 mb-3">
                  ...
                  <p class="form-control-plaintext">{{ country.nombre || '-' }}</p>
                </div>
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Código ISO:</label>
                  <p class="form-control-plaintext">{{ country.codigo_iso || '-' }}</p>
                </div>
                <div class="col-lg-6 mb-3">
  ...
  <!-- Add Country -->
  <div class="modal fade" id="add-country" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="page-wrapper-new p-0">
          <div class="content">
  ...
  <!-- Edit Country -->
  <div class="modal fade" id="edit-country" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="page-wrapper-new p-0">
          <div class="content">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        v-model="editFormData.codigo_iso"
                        maxlength="3"
                      />
                    </div>
                  </div>
      ...
      <div class="modal-content">
        <div class="page-wrapper-new p-0">
          <div class="content p-5 px-3 text-center">
            ...
            ></span>
            <h4 class="fs-20 text-gray-9 fw-bold mb-2 mt-1">Eliminar País</h4>
  ...
  methods: {
    async submitAddForm() {
      ...
      try {
        ...
        await axios.post('http://localhost:3000/api/v1/countries', this.formData, {
          headers: {
        ...
        this.$emit('country-saved');

        // Cerrar modal
        const modalElement = document.getElementById('add-country');
        if (modalElement) {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: error.response?.data?.message || 'Error al crear el país',
    ...
    async submitEditForm() {
      ...
      try {
        ...
        await axios.put(`http://localhost:3000/api/v1/countries/${id}`, updateData, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
        ...
        // Cerrar modal
        const modalElement = document.getElementById('edit-country');
        if (modalElement) {
          const closeButton = modalElement.querySelector('[data-bs-dismiss="modal"]');
          if (closeButton) closeButton.click();
        }
        ...
        this.$nextTick(() => {
          Swal.fire({
            icon: 'success',
            title: '¡Éxito!',
            text: 'País actualizado exitosamente',
            confirmButtonColor: '#28a745',
            timer: 2000,
            showConfirmButton: false
          });
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: error.response?.data?.message || 'Error al actualizar el país',
          confirmButtonColor: '#dc3545'
        });
      } finally {
        this.isSubmitting = false;
    ...
    async confirmDelete() {
      ...
      try {
        const token = localStorage.getItem('token');
        await axios.delete(`http://localhost:3000/api/v1/countries/${this.country.id}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
        ...
        this.$nextTick(() => {
          Swal.fire({
            icon: 'success',
            title: '¡Eliminado!',
            text: 'País eliminado exitosamente',
            confirmButtonColor: '#28a745',
            timer: 2000,
            showConfirmButton: false
          });
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: error.response?.data?.message || 'Error al eliminar el país',
          confirmButtonColor: '#dc3545'
        });
      } finally {
        this.isSubmitting = false;
