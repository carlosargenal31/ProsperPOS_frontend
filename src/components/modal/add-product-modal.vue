                        ...
                        <form action="javascript:void(0);" class="dropdown">
                          ...
                          >
                            ...
                            <div class="search-addon d-none">
                              <span><vue-feather type="x-circle"></vue-feather></span>
                            </div>
                          </div>
                          <div
              ...
              <div class="row">
                ...
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
                    ...
                    <vue-select :options="Typetax" v-model="selectedTwo" placeholder="Choose" />
                  </div>
                </div>
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
  ...
  data() {
    return {
      ...
      TypeDiscount: [
       ...
       {label:  "Early Payment", value:  "Early Payment"},
      ],
      Incometax: [
       {label:  "Choose", value:  "Choose"}, 
