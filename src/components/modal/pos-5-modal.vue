            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="KiloG" v-model="selectedTwo" placeholder="Kilogram" />
                </div>
              </div>
            </div>
          </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="PosTax" v-model="selectedThree" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="NewPos" v-model="selectedFour" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="FlatSel" v-model="selectedFive" placeholder="Select" />
            </div>
            <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="CreditSel" v-model="selectedSix" placeholder="Cash" />
                </div>
...
export default {
  data() {
    return {
      ...
      selectedFive: [],
      selectedSix: "Cash",
      selectedSeven: "Credit Card",
      selectedEight: "Cheque",
      selectedNine: "Deposit",
      selectedTen: "Points",
      Inclusive: [
