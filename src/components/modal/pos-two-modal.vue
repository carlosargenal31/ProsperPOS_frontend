            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  ...
                  >
                  <vue-select :options="Unit" v-model="selectedThree" placeholder="Kilogram" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      selected: "Exclusive",
      selectedTwo: "Percentage",
      selectedThree: "Kilogram",
      selectedFour: "Kilogram",
      selectedFive: "Kilogram",
      Taxtype: [
