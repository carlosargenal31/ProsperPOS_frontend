<template>
  <!-- Add Offer -->
  <div class="modal fade" id="add-offer" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <form @submit.prevent="submitAddForm" @keydown.enter="handleEnterKey">
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="mb-3">
                      <label class="form-label">Nombre de Oferta <span class="text-danger">*</span></label>
                      <input
                        type="text"
                        class="form-control"
                  ...
                  <div class="col-lg-6">
                    <div class="form-check mb-3">
                      <input
                        ...
                        type="checkbox"
                        id="limitar-hora"
                        v-model="formData.limitar_hora"
                      />
                      <label class="form-check-label" for="limitar-hora">
                        Limitar por rango de hora
                      </label>
                    </div>
                    <div v-if="formData.limitar_hora" class="row">
                      <div class="col-6">
                        <div class="mb-3">
                  ...
                  <div class="col-12">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="todos-dias" @change="toggleAllDays">
                        <label class="form-check-label" for="todos-dias">Todos</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="lunes" v-model="formData.aplica_lunes">
                        <label class="form-check-label" for="lunes">Lunes</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="martes" v-model="formData.aplica_martes">
                        <label class="form-check-label" for="martes">Martes</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="miercoles" v-model="formData.aplica_miercoles">
                        <label class="form-check-label" for="miercoles">Miércoles</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="jueves" v-model="formData.aplica_jueves">
                        <label class="form-check-label" for="jueves">Jueves</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="viernes" v-model="formData.aplica_viernes">
                        <label class="form-check-label" for="viernes">Viernes</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="sabado" v-model="formData.aplica_sabado">
                        <label class="form-check-label" for="sabado">Sábado</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="domingo" v-model="formData.aplica_domingo">
                ...
                <div class="row">
                  <div class="col-12">
                    <label class="form-label">La oferta aplica para:</label>
                    <div>
                      <div class="form-check">
                        <input
                          class="form-check-input"
                      ...
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          id="compras-mayores"
                          value="compras_mayores"
                          v-model="formData.aplica_para"
                        />
                        <label class="form-check-label" for="compras-mayores">
                          Compras mayores a
                        </label>
                        <input
                          v-if="formData.aplica_para === 'compras_mayores'"
                          type="number"
                          step="0.01"
                          class="form-control d-inline-block w-auto ms-2"
                          v-model="formData.monto_minimo"
                          placeholder="0.00"
                        />
                      </div>
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          id="cantidades-mayores"
                          value="cantidades_mayores"
                          v-model="formData.aplica_para"
                        />
                        <label class="form-check-label" for="cantidades-mayores">
                          Cantidades mayores a
                        </label>
                        <input
                          v-if="formData.aplica_para === 'cantidades_mayores'"
                          type="number"
                          class="form-control d-inline-block w-auto ms-2"
                          v-model="formData.cantidad_minima"
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                ...
                <div v-if="formData.tipo_aplicacion === 'multiple'" class="row mt-4">
                  <div class="col-12">
                    ...
                    <div class="alert alert-info" role="alert">
                      <i class="ti ti-info-circle"></i> Para los productos que tengan el descuento en "cero" se tomará el descuento base de la oferta.
                    </div>
                          ...
                          <tr v-for="(item, index) in formData.items" :key="index">
                            ...
                            <td>
                              <button
                                ...
                                @click="removeProductFromOffer(index)"
                              >
  ...
  <!-- View Offer Modal -->
  <div class="modal fade" id="view-offer" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-xl">
      <div class="modal-content">
        <div class="page-wrapper-new p-0">
          <div class="content">
            ...
            <div class="modal-body" v-if="offer">
              <div class="row">
                <div class="col-lg-3 mb-3">
                  ...
                  <p class="form-control-plaintext">{{ offer.codigo }}</p>
                </div>
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Nombre:</label>
                  <p class="form-control-plaintext">{{ offer.nombre }}</p>
                </div>
                <div class="col-lg-3 mb-3">
                  <label class="form-label fw-bold">Agencia:</label>
                  <p class="form-control-plaintext">{{ offer.agencia_nombre || 'N/A' }}</p>
                </div>
              </div>

              <!-- Para ofertas de tipo grupo o producto único -->
              <div v-if="offer.tipo_aplicacion !== 'multiple'" class="row">
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Categoría:</label>
                  <p class="form-control-plaintext">{{ offer.categoria_nombre || 'N/A' }}</p>
                </div>
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Subcategoría:</label>
                  <p class="form-control-plaintext">{{ offer.subcategoria_nombre || 'N/A' }}</p>
                </div>
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Producto:</label>
                  <p class="form-control-plaintext">{{ offer.producto_nombre || 'N/A' }}</p>
                </div>
              </div>

              <!-- Para ofertas de tipo múltiple: mostrar lista de productos -->
              <div v-if="offer.tipo_aplicacion === 'multiple' && offer.items && offer.items.length > 0" class="row">
                <div class="col-12 mb-3">
                  <label class="form-label fw-bold">Productos Incluidos ({{ offer.items.length }}):</label>
                  <div class="table-responsive">
              ...
              <div class="row">
                <div class="col-lg-4 mb-3">
                  ...
                  <p class="form-control-plaintext">{{ offer.tipo_descuento === 'porcentaje' ? 'Porcentaje' : 'Monto' }}</p>
                </div>
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Valor:</label>
                  <p class="form-control-plaintext">{{ offer.valor_descuento }}{{ offer.tipo_descuento === 'porcentaje' ? '%' : '' }}</p>
                </div>
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Estado:</label>
                  <p class="form-control-plaintext">
                    <span :class="offer.is_active ? 'badge bg-success' : 'badge bg-danger'">
              ...
              <div v-if="offer.limitar_fecha" class="row">
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Fecha Desde:</label>
                  <p class="form-control-plaintext">{{ offer.fecha_desde || 'N/A' }}</p>
                </div>
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Fecha Hasta:</label>
                  <p class="form-control-plaintext">{{ offer.fecha_hasta || 'N/A' }}</p>
                </div>
              </div>

              <div v-if="offer.limitar_hora" class="row">
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Hora Desde:</label>
                  <p class="form-control-plaintext">{{ offer.hora_desde || 'N/A' }}</p>
                </div>
                <div class="col-lg-6 mb-3">
                  <label class="form-label fw-bold">Hora Hasta:</label>
                  <p class="form-control-plaintext">{{ offer.hora_hasta || 'N/A' }}</p>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12 mb-3">
                  ...
                  <div class="d-flex gap-2 flex-wrap">
                    <span v-if="offer.aplica_lunes" class="badge bg-primary">Lunes</span>
                    <span v-else class="badge bg-secondary">Lunes</span>

                    <span v-if="offer.aplica_martes" class="badge bg-primary">Martes</span>
                    <span v-else class="badge bg-secondary">Martes</span>

                    <span v-if="offer.aplica_miercoles" class="badge bg-primary">Miércoles</span>
                    <span v-else class="badge bg-secondary">Miércoles</span>

                    <span v-if="offer.aplica_jueves" class="badge bg-primary">Jueves</span>
                    <span v-else class="badge bg-secondary">Jueves</span>

                    <span v-if="offer.aplica_viernes" class="badge bg-primary">Viernes</span>
                    <span v-else class="badge bg-secondary">Viernes</span>

                    <span v-if="offer.aplica_sabado" class="badge bg-primary">Sábado</span>
                    <span v-else class="badge bg-secondary">Sábado</span>

                    <span v-if="offer.aplica_domingo" class="badge bg-primary">Domingo</span>
              ...
              <div class="row">
                <div class="col-lg-4 mb-3">
                  ...
                  <p class="form-control-plaintext">
                    {{ offer.aplica_para === 'todos' ? 'Todos' : offer.aplica_para === 'compras_mayores' ? 'Compras Mayores' : 'Cantidades Mayores' }}
                  </p>
                </div>
                <div class="col-lg-4 mb-3" v-if="offer.aplica_para === 'compras_mayores'">
                  <label class="form-label fw-bold">Monto Mínimo:</label>
                  <p class="form-control-plaintext">{{ formatMoney(offer.monto_minimo) }}</p>
                </div>
                <div class="col-lg-4 mb-3" v-if="offer.aplica_para === 'cantidades_mayores'">
                  <label class="form-label fw-bold">Cantidad Mínima:</label>
                  <p class="form-control-plaintext">{{ offer.cantidad_minima }}</p>
                </div>
                <div class="col-lg-4 mb-3">
                  <label class="form-label fw-bold">Suspendida:</label>
                  <p class="form-control-plaintext">
                    <span :class="offer.suspendida ? 'badge bg-warning' : 'badge bg-success'">
                      {{ offer.suspendida ? 'SÍ' : 'NO' }}
                    </span>
                  </p>
                </div>
              </div>
  ...
  <div class="modal fade" id="delete-offer-modal">
...
export default {
  ...
  emits: ['offer-saved', 'offer-deleted'],
  data() {
    return {
      branches: [],
      categories: [],
  ...
  watch: {
    offer: {
      handler(newVal) {
        if (newVal && newVal.id) {
          console.log('Loading offer in watch:', newVal);
          console.log('Items from offer:', newVal.items);
  ...
  methods: {
    ...
    async generateNextCode() {
      try {
        const token = localStorage.getItem('token');
        const response = await axios.get('http://localhost:3000/api/v1/offers/next-code', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
    ...
    async submitAddForm() {
      ...
      try {
        ...
        if (this.formData.id) {
          ...
          await axios.put(`http://localhost:3000/api/v1/offers/${this.formData.id}`, dataToSend, {
            headers: { 'Authorization': `Bearer ${token}` }
          });
        } else {
          // Crear nueva oferta
          await axios.post('http://localhost:3000/api/v1/offers', dataToSend, {
            headers: { 'Authorization': `Bearer ${token}` }
          });
        }
        ...
        this.$nextTick(() => {
          Swal.fire({
            icon: 'success',
            title: '¡Éxito!',
            text: this.formData.id ? 'Oferta actualizada exitosamente' : 'Oferta creada exitosamente',
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: error.response?.data?.message || 'Error al guardar la oferta',
    ...
    openDeleteModal() {
      const addModal = document.getElementById('add-offer');
      if (addModal) {
      ...
      setTimeout(() => {
        const deleteModalElement = document.getElementById('delete-offer-modal');
        const deleteModalButton = document.querySelector('[data-bs-target="#delete-offer-modal"]');
    ...
    async confirmDelete() {
      ...
      try {
        const token = localStorage.getItem('token');
        await axios.delete(`http://localhost:3000/api/v1/offers/${this.offer.id}`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });

        this.$emit('offer-deleted');

        const modalElement = document.getElementById('delete-offer-modal');
        if (modalElement) {
          const closeButton = modalElement.querySelector('[data-bs-dismiss="modal"]');
          if (closeButton) closeButton.click();
        }
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: error.response?.data?.message || 'Error al eliminar la oferta',
          confirmButtonColor: '#dc3545'
        });
      } finally {
        this.isSubmitting = false;
