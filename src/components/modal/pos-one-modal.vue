          ...
          <div class="card bg-light mb-3">
            <div class="card-body">
              ...
              <div class="product-wrap h-auto">
                <div
                  class="product-list bg-white align-items-center justify-content-between"
                >
                  <div
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label"
                >Order Reference <span class="text-danger">*</span></label
              >
          ...
          <div class="modal-body pb-1">
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  <label class="form-label"
                    >Tax Type <span class="text-danger">*</span></label
                  >
                  <vue-select :options="Taxtype" v-model="selected" placeholder="Exclusive" />
                </div>
              </div>
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="mb-3">
                  <label class="form-label"
                    >Sale Unit <span class="text-danger">*</span></label
                  >
                  <vue-select :options="Sale" v-model="selectedTwo" placeholder="Kilogram" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="tabs-sets">
            ...
            <div class="tab-content">
              ...
              >
                <div class="card table-list-card mb-0">
                  <div
                  ...
                  <div class="card bg-light mb-3">
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          <p class="fs-15 mb-1">
                            <span class="fs-14 fw-bold text-gray-9">Cashier :</span> admin
                          </p>
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Total :</span> $900
                          </p>
                        </div>
                        <div class="col-md-6">
                          <p class="fs-15 mb-1">
                            <span class="fs-14 fw-bold text-gray-9">Customer :</span>
                            Botsford
                          </p>
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec
                            2024 13:39:11
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        <a href="javascript:void(0);" class="btn btn-md btn-orange"
                          >Open Order</a
                        >
                        <a
                          href="javascript:void(0);"
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        <div class="row g-3">
                          <div class="col-md-6">
                            <p class="fs-15 mb-1">
                              <span class="fs-14 fw-bold text-gray-9">Cashier :</span>
                              admin
                            </p>
                            <p class="fs-15">
                              <span class="fs-14 fw-bold text-gray-9">Total :</span> $900
                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          ...
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Total :</span> $1000
                          </p>
                        </div>
                        <div class="col-md-6">
                          <p class="fs-15 mb-1">
                            <span class="fs-14 fw-bold text-gray-9">Customer :</span> Hugo
                          </p>
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec
                            2024 13:39:11
                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          ...
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Total :</span> $9100
                          </p>
                        </div>
                        <div class="col-md-6">
                          <p class="fs-15 mb-1">
                          ...
                          <p class="fs-15">
                            <span class="fs-14 fw-bold text-gray-9">Date :</span> 23 Dec
                            2024 13:39:11
                          </p>
                        </div>
                      </div>
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              <label class="form-label"
                >Order Tax <span class="text-danger">*</span></label
              >
              <vue-select :options="Order" v-model="selectedThree" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              ...
              >
              <vue-select :options="Coupon" v-model="selectedFour" placeholder="Select" />
            </div>
          </div>
          <div class="modal-footer d-flex justify-content-end flex-wrap gap-2">
            <button
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body pb-1">
            <div class="mb-3">
              <label class="form-label"
                >Order Discount Type <span class="text-danger">*</span></label
              >
              <vue-select :options="OrderType" v-model="selectedFive" placeholder="Select" />
            </div>
            <div class="mb-3">
        ...
        <div class="modal-body p-0">
          <div class="success-wrap">
            <div class="text-center">
              ...
              <div
                class="p-2 d-flex align-items-center justify-content-center gap-2 flex-wrap mb-3"
              >
                <p class="fs-13 fw-medium pe-2 border-end mb-0">
                  Bill Amount : <span class="text-gray-9">$150</span>
                </p>
                <p class="fs-13 fw-medium pe-2 border-end mb-0">
                  Total Paid : <span class="text-gray-9">$200</span>
                </p>
                <p class="fs-13 fw-medium mb-0">
                  Change : <span class="text-gray-9">$50</span>
                </p>
              </div>
            </div>
            <div
              class="bg-success-transparent p-2 mb-3 br-5 border-start border-success d-flex align-items-center"
            >
              <span
                class="avatar avatar-sm bg-success rounded-circle flex-shrink-0 fs-16 me-2"
              >
                <i class="ti ti-mail-opened"></i>
              </span>
              <p class="fs-13 fw-medium text-gray-9">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap">
              <button
                type="button"
                class="btn btn-md btn-light flex-fill"
                data-bs-toggle="modal"
                data-bs-target="#print-receipt"
              >
                <i class="ti ti-printer me-1"></i>Print Receipt
              </button>
              <button type="button" class="btn btn-md btn-teal flex-fill">
                <i class="ti ti-gift me-1"></i>Gift Receipt
              </button>
              <a href="#" class="btn btn-md btn-dark flex-fill"
                ><i class="ti ti-shopping-cart me-1"></i>Next Order</a
              >
            </div>
          </div>
        </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body">
            <div class="bg-info-transparent p-2 br-8 mb-3">
              <p class="text-info">
                Balance isn’t enough to pay, you can still make a partial payment
              </p>
            </div>
            ...
            <div
              class="bg-danger-transparent p-2 mb-3 br-5 border-start border-danger d-flex align-items-center"
            >
            ...
            <div class="additem-info">
              <div class="bg-light p-3 add-info">
                <div class="row align-items-center g-2">
                  ...
                  <div class="col-lg-4">
                    <vue-select :options="Payment" v-model="selectedSix" placeholder="Cash" />
                  </div>
                  <div class="col-lg-4">
              ...
              <div class="bg-light p-3 add-info">
                <div class="row align-items-center g-2">
                  ...
                  <div class="col-lg-4">
                    <vue-select :options="Payment" v-model="selectedSeven" placeholder="Cash" />
                  </div>
                  <div class="col-lg-4">
                    <input type="text" class="form-control" placeholder="Enter Amount" />
                  </div>
          ...
          <div class="modal-body pb-1">
            <div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label"
                    >Received Amount <span class="text-danger">*</span></label
                  >
                  <div class="input-icon-start position-relative">
                    <span class="input-icon-addon text-gray-9">
                      <i class="ti ti-currency-dollar"></i>
              ...
              <div class="col-md-12">
                ...
                <div class="point-wrap payment-content mb-3">
                  ...
                  >
                    <h6 class="fs-14 fw-bold text-success">
                      You have 2000 Points to Use
                    </h6>
                    <a href="javascript:void(0);" class="btn btn-dark btn-md"
                      >Use for this Purchase</a
                    >
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body p-0">
          <div class="calculator-wrap">
            ...
            <div class="calculator-body d-flex justify-content-between">
              ...
              <div class="text-center">
                <button class="btn btn-clear" onclick="back()">
            ...
            <table class="table table-striped border">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-gray-9 fw-bold text-end bg-secondary-transparent">
                    $587130.97
                  </td>
                </tr>
              </tbody>
        ...
        <div class="modal-body">
          <div class="row justify-content-center g-3 mb-3">
            <div class="col-lg-4 col-md-6 d-flex">
              <div
                class="border border-success bg-success-transparent br-8 p-3 flex-fill"
              >
...
export default {
  ...
  data() {
    return {
      selected: "Exclusive",
      selectedOne: "Percentage",
      selectedTwo: "Kilogram",
      selectedThree: [],
      selectedFour: [],
      selectedFive: [],
      selectedSix: "Cash",
      ...
      Discount: [
        ...
        {label: "Early Payment Discounts", value: "Early Payment Discounts"},
      ],
      Sale: [
      ...
      Order: [
        ...
        {label: "@15", value: "@15"}, 
        {label: "VAT", value: "VAT"}, 
        {label: "SLTAX", value: "SLTAX"}, 
      ],
      Coupon: [
        {label: "Select", value: "Select"}, 
        {label: "NEWYEAK30", value: "NEWYEAK30"}, 
        {label: "CHRISTMAS100", value: "CHRISTMAS100"}, 
        {label: "HALLOWEEN20", value: "HALLOWEEN20"}, 
        {label: "BLACKFRIDAY50", value: "BLACKFRIDAY50"}, 
      ],
      OrderType: [
        {label: "Select", value: "Select"}, 
