            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <vue-select :options="Status" v-model="selectedFour" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label"
                    >Plan Type <span class="text-danger"> *</span></label
                  >
                  <vue-select :options="PlanType" v-model="selectedSix" placeholder="Monthly" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label"
                    >Currency <span class="text-danger"> *</span></label
                  >
                  <vue-select :options="Currency" v-model="selectedSeven" placeholder="USD" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue-select :options="Status" v-model="selectedNine" placeholder="Active" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label"
                    >Plan Name <span class="text-danger">*</span></label
                  >
                  <vue-select :options="PlanNames" v-model="selectedTen" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label"
                    >Plan Type <span class="text-danger">*</span></label
                  >
                  <vue-select :options="PlanType" v-model="selectedEleven" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        <div class="modal-body text-center">
          <span
            class="avatar avatar-xl bg-danger-transparent rounded-circle text-danger mb-3"
          >
          ...
          <div class="d-flex justify-content-center">
            <a
              ...
              >Cancel</a
            >
            <router-link to="/super-admin/companies" class="btn btn-primary"
...
export default {
  data() {
    return {
      ...
      selectedThree: [],
      selectedFour: [],
      selectedFive: "Advanced",
      selectedSix: "Monthly",
      selectedSeven: "USD",
      selectedEight: "English",
      selectedNine: "Active",
      selectedTen: [],
      selectedEleven: [],
      PlanName: [
